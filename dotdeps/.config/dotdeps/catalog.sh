...
register_dep shell git "Git" cmd "git" "git|git" "VCS"
register_dep shell curl "curl" cmd "curl" "curl|curl" "Fetch tool"
register_dep shell zsh "zsh" cmd "zsh" "zsh|zsh" "Shell"
register_dep shell stow "GNU Stow" cmd "stow" "stow|stow" "Symlink manager"
register_dep shell fzf "fzf" cmd "fzf" "fzf|fzf" "Interactive selector"
register_dep shell zoxide "zoxide" cmd "zoxide" "zoxide|zoxide" "Smart cd"
register_dep shell bat "bat" cmd "bat batcat" "bat|bat" "Debian may expose batcat"
register_dep shell eza "eza" cmd "eza" "eza|eza" "ls replacement"
register_dep shell jq "jq" cmd "jq" "jq|jq" "JSON helper"
register_dep shell yazi "yazi" cmd "yazi" "yazi|yazi" "File manager"
register_dep shell ranger "ranger" cmd "ranger" "ranger|ranger" "File manager"
register_dep shell lazygit "lazygit" cmd "lazygit" "lazygit|lazygit" "Git TUI"
...
register_dep tmux tmux "tmux" cmd "tmux" "tmux|tmux" "Terminal multiplexer"
...
register_dep nvim neovim "Neovim" cmd "nvim" "neovim|neovim" "Editor"
...
register_dep devtools ripgrep "ripgrep" cmd "rg" "ripgrep|ripgrep" "Search tool"
register_dep devtools fd "fd" cmd "fd fdfind" "fd-find|fd" "File finder"
register_dep devtools unzip "unzip" cmd "unzip" "unzip|unzip" "Archive support"
register_dep devtools tar "tar" cmd "tar" "tar|tar" "Archive support"
register_dep devtools make "make" cmd "make" "build-essential|base-devel" "Build tool"
register_dep devtools gcc "gcc" cmd "gcc" "build-essential|base-devel" "Compiler"
register_dep devtools node "nodejs" cmd "node" "nodejs npm|nodejs npm" "JavaScript runtime"
register_dep devtools npm "npm" cmd "npm" "nodejs npm|nodejs npm" "Package manager"
register_dep devtools python3 "python3" cmd "python3" "python3 python3-pip|python python-pip" "Python runtime"
register_dep devtools pip "python3-pip" cmd "pip3" "python3-pip|python-pip" "Python package installer"
register_dep devtools cmake "cmake" cmd "cmake" "cmake|cmake" "Build system"
register_dep devtools docker "Docker" cmd "docker" "docker.io|docker" "Containers"
register_dep devtools helm "Helm" cmd "helm" "helm|helm" "Kubernetes packaging"
register_dep devtools prettier "Prettier" cmd "prettier" "prettier|prettier" "Formatter"
register_dep devtools eslint "ESLint" cmd "eslint" "eslint|eslint" "Linter"
register_dep devtools stylua "Stylua" cmd "stylua" "stylua|stylua" "Lua formatter"
register_dep devtools shfmt "shfmt" cmd "shfmt" "shfmt|shfmt" "Shell formatter"
register_dep devtools ruff "Ruff" cmd "ruff" "ruff|ruff" "Python linter"

register_dep desktop hyprland "Hyprland" cmd "Hyprland hyprctl" "hyprland|hyprland" "Compositor"
register_dep desktop kitty "kitty" cmd "kitty" "kitty|kitty" "Terminal"
register_dep desktop rofi "Rofi" cmd "rofi" "rofi|rofi" "Launcher"
register_dep desktop waybar "Waybar" cmd "waybar" "waybar|waybar" "Bar"
register_dep desktop hyprpicker "Hyprpicker" cmd "hyprpicker" "hyprpicker|hyprpicker" "Color picker"
register_dep desktop playerctl "playerctl" cmd "playerctl" "playerctl|playerctl" "Media control"
register_dep desktop brightnessctl "brightnessctl" cmd "brightnessctl" "brightnessctl|brightnessctl" "Brightness"
register_dep desktop wl_clipboard "wl-clipboard" cmd "wl-copy wl-paste" "wl-clipboard|wl-clipboard" "Clipboard"
register_dep desktop cliphist "cliphist" cmd "cliphist" "cliphist|cliphist" "Clipboard history"
register_dep desktop pavucontrol "pavucontrol" cmd "pavucontrol" "pavucontrol|pavucontrol" "Audio control"
register_dep desktop blueman "blueman" cmd "blueman-manager" "blueman|blueman" "Bluetooth"
register_dep desktop nm_applet "network-manager-applet" cmd "nm-applet" "network-manager-applet|network-manager-applet" "Network applet"
register_dep desktop swww "swww" cmd "swww" "swww|swww" "Wallpaper manager"
register_dep desktop xdg_portal "xdg-desktop-portal-gtk" cmd "xdg-desktop-portal-gtk" "xdg-desktop-portal-gtk|xdg-desktop-portal-gtk" "Portal"
register_dep desktop dolphin "Dolphin" cmd "dolphin" "dolphin|dolphin" "File manager"
register_dep desktop code "VS Code" cmd "code" "code|code" "Editor"
register_dep desktop zen_browser "Zen Browser" cmd "zen-browser" "zen-browser|zen-browser" "Browser"
register_dep desktop firefox "Firefox" cmd "firefox" "firefox|firefox" "Browser"
register_dep desktop vlc "VLC" cmd "vlc" "vlc|vlc" "Media player"
register_dep desktop ark "Ark" cmd "ark" "ark|ark" "Archive manager"
register_dep desktop nwg_look "nwg-look" cmd "nwg-look" "nwg-look|nwg-look" "Qt theming"
register_dep desktop qt5ct "qt5ct" cmd "qt5ct" "qt5ct|qt5ct" "Qt theming"
register_dep desktop qt6ct "qt6ct" cmd "qt6ct" "qt6ct|qt6ct" "Qt theming"
register_dep desktop kvantum "kvantummanager" cmd "kvantummanager" "kvantum|kvantum" "Qt theming"
